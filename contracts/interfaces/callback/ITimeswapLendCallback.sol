...
interface ITimeswapLendCallback {
    ...
    /// @dev In the implementation you must pay the pair tokens owed for the lend transaction.
    /// The caller of this method must be checked to be a TimeswapPair deployed by the canonical TimeswapFactory.
    /// @param amountOwed The amount of asset tokens owed due to the pool for the lend transaction
