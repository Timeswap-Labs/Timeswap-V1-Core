...
export function pay(): any {
    const mintTests = Mint.mintTestCases(); // getting the mint Test Cases
    const lendTests = Lend.lendTestCases(); // getting the lend Test Cases
    const borrowTests = Borrow.borrowTestCases(); // getting the borrow Test Cases
