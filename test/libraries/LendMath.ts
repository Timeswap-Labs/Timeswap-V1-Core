...
export function getFees(maturity: bigint, assetIn: bigint, fee: bigint, protocolFee: bigint, now: bigint) {
  let totalFee = fee
...
export function getInsuranceInterest(maturity: bigint, cdpDecrease: bigint, now: bigint) {
